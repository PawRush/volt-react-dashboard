...
// Local development stacks (preview environments)
...
// Pipeline stack (production deployment)
if (codeConnectionArn) {
  new PipelineStack(app, "VoltReactPipelineStack", {
    env: { account, region },
    description: "CI/CD Pipeline for VoltReact",
    codeConnectionArn,
    repositoryName,
    branchName,
